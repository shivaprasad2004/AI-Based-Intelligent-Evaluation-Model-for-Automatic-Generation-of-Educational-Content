...
import { MessageSquare, X, Send, Brain, Lightbulb, HelpCircle, BookOpen, Loader2 } from 'lucide-react';
...
export default function AIChatbot({ topicId, topicName }) {
  ...
  const [messages, setMessages] = useState([
    { role: 'bot', text: `Hi! I'm your AI tutor. ${topicName ? `Ask me anything about ${topicName}!` : 'How can I help you learn today?'}` }
  ]);
